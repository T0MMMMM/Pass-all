...
public abstract class Cryptage
{
    ...
    public static string? DllEncrypt(string? input)
    {
    ...
    public static string? DllDecrypt(string? input)
    {
        if (string.IsNullOrEmpty(input))
            return null;
    ...
    public static string? DllHash(string? input)
    {
        if (string.IsNullOrEmpty(input))
            return null;
